...
\end{figure}
 ...
 \item In  \figref{fig:Figureh_1}, $ABC$ is an isosceles triangle right angled at $C$ with $AC = 4 cm$. Find the length of $AB$.
\begin{figure}[H]
    \centering
...
\item In  \figref{fig:Figureh_2}, $DE \parallel BC$. Find the length of side $AD$, given that $AE = 1.8 cm$, $ BD = 7.2 cm$ and $ CE = 5.4 cm$.
\begin{figure}[H]
    \centering
