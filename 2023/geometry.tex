...
\begin{enumerate}
    ...
    \end{enumerate}   
\item  In the given \figref{fig:triangle}, $DE$ $\parallel$ $BC$. If $AD$=$2$ units, $DB=AE=3$ units and $EC=x$ units, then the value of $x$ is:
\begin{figure}[H]
    \centering
...
\end{enumerate}
\item In the given \figref{fig:figure}, $XZ$ is parallel to $BC$. $AZ = 3$ cm, $ZC = 2$ cm, $BM = 3$ cm, and $MC = 5$ cm. Find the length of $XY$.
